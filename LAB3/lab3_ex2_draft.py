...
Tensorflow : Channel last format 

N..C 

1- Time Series  AS Temp and humdidity [batch , L length the length of the sequence : 6  , C  channels : 2 (1 temp , 1 humi) ]

2- Audio : NLC 

3- Image / STFT / MFCC : NHWC (C=1)
